const CACHE="koala-v1-6-2";
const ASSETS=["./","index.html","koala-v1-6-2.css","koala-v1-6-2.js","manifest.webmanifest","icons/icon-192.png","icons/icon-512.png","icons/koala-avatar.png","icons/koala-hero.png","icons/koala-small.png"];
