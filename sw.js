const CACHE="koala-v1-6";
const ASSETS=["./","index.html","koala-v1-6.css","koala-v1-6.js","manifest.webmanifest","icons/icon-192.png","icons/icon-512.png","icons/koala-avatar.png","icons/koala-hero.png","icons/koala-small.png"];
