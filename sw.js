const CACHE="koala-v1-7-1-icon";
const ASSETS=["./","index.html","koala-v1-7.css","koala-v1-7.js","manifest.webmanifest","icons/icon-192.png","icons/icon-512.png","icons/apple-touch-icon.png","icons/icon-192.png","icons/icon-512.png","icons/apple-touch-icon.png"];
